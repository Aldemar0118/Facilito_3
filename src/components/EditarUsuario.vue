...
export default {
  ...
  created() {
    let apiURL = `https://ell.inventariofacilito.cf:4000/api/user/edit-usuario/${this.$route.params.id}`;
  ...
  methods: {
    handleUpdateForm() {
      let apiURL = `https://ell.inventariofacilito.cf:4000/api/user/update-usuario/${this.$route.params.id}`;
