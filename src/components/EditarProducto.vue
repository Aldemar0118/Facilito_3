...
export default {
  ...
  created() {
    let apiURL = `https://ipa.inventariofacilito.cf/api/edit-producto/${this.$route.params.id}`;
  ...
  methods: {
    handleUpdateForm() {
      let apiURL = `https://ipa.inventariofacilito.cf/api/update-producto/${this.$route.params.id}`;
